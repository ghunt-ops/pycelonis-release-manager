...
class Package(ContentNode):
    ...
    def create_folder(self, name: str, key: Optional[str] = None, **kwargs: Any) -> "Folder":
        ...
        content_node_transport = PackageManagerService.post_api_nodes(
            ...
            ).json_dict(by_alias=True, exclude_unset=True),
        )
    ...
    def get_folders(self) -> CelonisCollection["Folder"]:
        ...
        """
        return cast(CelonisCollection["Folder"], self.get_content_nodes(node_type=ContentNodeType.FOLDER))
        ...
        **kwargs: Any,
        ...
        configuration = {
            "metadata": {
                ...
                "key": key,
                "template": template,
                "allowAdvancedFilters:": allow_advanced_filters,
            },
            "layout": {
                "rows": [],
            },
